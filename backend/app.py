...
# sample link https://api.projectnull76.web.illinois.edu//api/message/mysql/update?messageId=15&content=UpdatedHelloWorld
# https://api.projectnull76.web.illinois.edu//api/message/mysql/update?messageId=14
